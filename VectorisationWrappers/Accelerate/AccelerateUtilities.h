...
namespace Vectorised::Utilities
{
    ...
    //         vDSP_vscal (&ScalarValue, InputBuffer, InputStride, OutputBuffer, OutputStride, BufferSize);
    //     else if constexpr (std::is_same_v<T, double>)
    //         vDSP_vscalD (&ScalarValue, InputBuffer, InputStride, OutputBuffer, OutputStride, BufferSize);
    // }
